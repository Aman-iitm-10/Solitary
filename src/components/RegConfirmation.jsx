    ...
    return (
        <div className="container" style={{ height: '100%' }}>
            ...
            <div className="row mt-3" style={{ textAlign: 'center' }}>
                <pre className="text-wrap regConfMessage">
                    {' '}
                    Stay updated via emails and WhatsApp messages. Make use of
                    the opportunities.{' '}
                </pre>
            </div>
            <div className="mt-3">
                <pre
                    className="regConfMessage text-[18px]"
                    style={{ textAlign: 'center' }}
                >
                    For futher details: {props.contact}
                </pre>
            </div>

                ...
                <div className="col-5">
                    ...
                    <div className="RegisterContainer mt-4">
                        <form className="mp-2 p-5">
                            <div className="p-2">Register Here</div>
                            <div className="form-group p-2">
                                <input
                                    type="text"
                                    className="form-control pt-1 pb-1 pl-3 rounded-pill"
                            ...
                            >
                                ...
                                <button
                                    type="submit"
                                    className="btn register-button p-2"
                                >
                                    Register
                                </button>
                            </div>
                ...
                <div className="col-7">
                    <div className="ml-6">
                        ...
                        <>
                            ...
                            <div className="mt-10 ml-20 loopinfoStyle ">
